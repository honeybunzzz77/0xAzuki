...
export declare type Action = AddChainsAction | AddWalletAction | UpdateWalletAction | RemoveWalletAction | ResetStoreAction | UpdateAccountAction | SetWalletModulesAction;
