...
var require_EventListener = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/connection/EventListener.js"(exports) {
    init_virtual_process_polyfill();
    init_buffer();
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@coinbase/wallet-sdk/node_modules/eth-block-tracker/src/base.js
var require_base = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/eth-block-tracker/src/base.js"(exports, module) {
    init_virtual_process_polyfill();
    init_buffer();
...
// node_modules/@coinbase/wallet-sdk/node_modules/eth-block-tracker/src/polling.js
var require_polling = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/eth-block-tracker/src/polling.js"(exports, module) {
    init_virtual_process_polyfill();
    init_buffer();
    var pify = require_pify();
...
var require_Spinner = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/components/Spinner.js"(exports) {
    ...
    var Spinner = (props) => {
      ...
      return (0, preact_1.h)("div", { class: "-cbwsdk-spinner" }, (0, preact_1.h)("style", null, Spinner_css_1.default), (0, preact_1.h)("svg", { viewBox: "0 0 100 100", xmlns: "http://www.w3.org/2000/svg", style: { width: size, height: size } }, (0, preact_1.h)("circle", { style: { cx: 50, cy: 50, r: 45, stroke: color } })));
    };
    exports.Spinner = Spinner;
  }
});

// node_modules/@coinbase/wallet-sdk/dist/components/LinkDialog.js
var require_LinkDialog = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/components/LinkDialog.js"(exports) {
    init_virtual_process_polyfill();
    init_buffer();
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
    ...
    var LinkDialog = (props) => {
      ...
      return (0, preact_1.h)("div", { class: (0, clsx_1.default)("-cbwsdk-link-dialog-container", props.darkMode && "-cbwsdk-link-dialog-container-dark", isContainerHidden && "-cbwsdk-link-dialog-container-hidden") }, (0, preact_1.h)("style", null, LinkDialog_css_1.default), (0, preact_1.h)("div", { class: (0, clsx_1.default)("-cbwsdk-link-dialog-backdrop", isDialogHidden && "-cbwsdk-link-dialog-backdrop-hidden") }), (0, preact_1.h)("div", { class: "-cbwsdk-link-dialog" }, (0, preact_1.h)("div", { class: (0, clsx_1.default)("-cbwsdk-link-dialog-box", isDialogHidden && "-cbwsdk-link-dialog-box-hidden") }, (0, preact_1.h)(ScanQRCode, { darkMode: props.darkMode, version: props.version, sessionId: props.sessionId, sessionSecret: props.sessionSecret, linkAPIUrl: props.linkAPIUrl, isConnected: props.isConnected, isParentConnection: props.isParentConnection }), props.onCancel && (0, preact_1.h)(CancelButton, { onClick: props.onCancel }))));
    };
    ...
    var ScanQRCode = (props) => {
      ...
      return (0, preact_1.h)("div", { class: "-cbwsdk-link-dialog-box-content" }, (0, preact_1.h)("h3", null, "Scan to", (0, preact_1.h)("br", null), " Connect"), (0, preact_1.h)("div", { class: "-cbwsdk-link-dialog-box-content-qrcode" }, (0, preact_1.h)("div", { class: "-cbwsdk-link-dialog-box-content-qrcode-wrapper" }, (0, preact_1.h)(QRCode_1.QRCode, { content: qrUrl, width: 224, height: 224, fgColor: "#000", bgColor: "transparent" })), (0, preact_1.h)("input", { type: "hidden", name: "cbwsdk-version", value: version_1.LIB_VERSION }), (0, preact_1.h)("input", { type: "hidden", value: qrUrl }), !props.isConnected && (0, preact_1.h)("div", { class: "-cbwsdk-link-dialog-box-content-qrcode-connecting" }, (0, preact_1.h)(Spinner_1.Spinner, { size: 128, color: props.darkMode ? "#fff" : "#000" }), (0, preact_1.h)("p", null, "Connecting...")), (0, preact_1.h)("p", { title: `Coinbase Wallet SDK v${props.version}` }, "Powered by Coinbase Wallet SDK")), (0, preact_1.h)("a", { href: `${props.linkAPIUrl}/#/wallets`, target: "_blank", rel: "noopener" }, "Don\u2019t have a wallet app?"));
    };
    var CancelButton = (props) => (0, preact_1.h)("button", { class: "-cbwsdk-link-dialog-box-cancel", onClick: props.onClick }, (0, preact_1.h)("div", { class: "-cbwsdk-link-dialog-box-cancel-x" }));
  }
});
...
var require_TryExtensionLinkDialog = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/components/TryExtensionLinkDialog.js"(exports) {
    ...
    var TryExtensionBox = ({ onInstallClick }) => {
      ...
      return (0, preact_1.h)("div", { class: "-cbwsdk-extension-dialog-box-top" }, (0, preact_1.h)("div", { class: "-cbwsdk-extension-dialog-box-top-install-region" }, (0, preact_1.h)("h2", null, "Try the Coinbase Wallet extension"), isClicked && (0, preact_1.h)("div", { class: "-cbwsdk-extension-dialog-box-top-subtext" }, "After installing Coinbase Wallet, refresh the page and connect again."), (0, preact_1.h)("button", { type: "button", onClick: clickHandler }, isClicked ? "Refresh" : "Install")), (0, preact_1.h)("div", { class: "-cbwsdk-extension-dialog-box-top-info-region" }, (0, preact_1.h)(DescriptionItem, { icon: link_icon_svg_1.default, text: "Connect to crypto apps with one click" }), (0, preact_1.h)(DescriptionItem, { icon: lock_icon_svg_1.default, text: "Your private key is stored securely" }), (0, preact_1.h)(DescriptionItem, { icon: globe_icon_svg_1.default, text: "Works with Ethereum, Polygon, and more" })));
    };
    var ScanQRBox = (props) => {
      const serverUrl = window.encodeURIComponent(props.linkAPIUrl);
      const sessionIdKey = props.isParentConnection ? "parent-id" : "id";
      const qrUrl = `${props.linkAPIUrl}/#/link?${sessionIdKey}=${props.sessionId}&secret=${props.sessionSecret}&server=${serverUrl}&v=1`;
      return (0, preact_1.h)("div", { class: "-cbwsdk-extension-dialog-box-bottom" }, (0, preact_1.h)("div", { class: "-cbwsdk-extension-dialog-box-bottom-description-region" }, (0, preact_1.h)("h2", null, "Or scan to connect"), (0, preact_1.h)("body", { class: "-cbwsdk-extension-dialog-box-bottom-description" }, "Open", " ", (0, preact_1.h)("a", { href: "https://wallet.coinbase.com/", target: "_blank", rel: "noopener noreferrer" }, "Coinbase Wallet"), " ", "on your mobile phone and scan")), (0, preact_1.h)("div", { class: "-cbwsdk-extension-dialog-box-bottom-qr-region" }, (0, preact_1.h)("div", { class: "-cbwsdk-extension-dialog-box-bottom-qr-wrapper" }, (0, preact_1.h)(QRCode_1.QRCode, { content: qrUrl, width: 150, height: 150, fgColor: "#000", bgColor: "transparent", image: {
        svg: QRLogo_1.default,
        width: 34,
        height: 34
      } })), (0, preact_1.h)("input", { type: "hidden", name: "cbwsdk-version", value: version_1.LIB_VERSION }), (0, preact_1.h)("input", { type: "hidden", value: qrUrl }), !props.isConnected && (0, preact_1.h)("div", { class: "-cbwsdk-extension-dialog-box-bottom-qr-connecting" }, (0, preact_1.h)(Spinner_1.Spinner, { size: 36, color: "#000" }), (0, preact_1.h)("p", null, "Connecting..."))));
    };
    var DescriptionItem = (props) => {
      return (0, preact_1.h)("div", { class: "-cbwsdk-extension-dialog-box-top-description" }, (0, preact_1.h)("div", { class: "-cbwsdk-extension-dialog-box-top-description-icon-wrapper" }, (0, preact_1.h)("img", { src: props.icon })), (0, preact_1.h)("body", { class: "-cbwsdk-extension-dialog-box-top-description-text" }, props.text));
    };
    var CancelButton = (props) => (0, preact_1.h)("button", { type: "button", class: "-cbwsdk-extension-dialog-box-cancel", onClick: props.onClick }, (0, preact_1.h)("div", { class: "-cbwsdk-extension-dialog-box-cancel-x" }));
  }
});
...
// dep:@coinbase_wallet-sdk
init_virtual_process_polyfill();
init_buffer();
var coinbase_wallet_sdk_default = require_dist2();
export {
  coinbase_wallet_sdk_default as default
};
