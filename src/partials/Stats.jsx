    ...
    <section className="relative">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          <div className="grid grid-cols-1 gap-4 lg:gap-6 md:grid-cols-3 text-center" data-aos-id-stats>
            {/* 1st item */}
            ...
            <div className="bg-white dark:bg-gray-800 py-8 px-1 shadow-2xl rounded-md" data-aos="fade-down" data-aos-anchor="[data-aos-id-stats]" data-aos-delay="200">
              <div className="font-red-hat-display text-3xl font-extrabold tracking-tighter mb-1">0.01 ETH</div>
