      ...
      <div className="py-12 md:py-20">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 font-red-hat-display mb-4">JOIN THE COMMUNITY</h1>
          </div>
        ...
        <div className="carousel swiper-container">
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide max-w-lg">
              <img className="transition-opacity duration-300 rounded-md" src={CarouselImage01} width="540" height="460" alt="Carousel item 01" />
            ...
            <div className="swiper-slide max-w-lg">
              <img className="transition-opacity duration-300 rounded-md" src={CarouselImage02} width="540" height="460" alt="Carousel item 02" />
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="flex grow">
                </div>
                <div className="absolute bottom-0 right-0 p-6">
            ...
            <div className="swiper-slide max-w-lg">
              <img className="transition-opacity duration-300 rounded-md" src={CarouselImage03} width="540" height="460" alt="Carousel item 03" />
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="flex grow">
                </div>
                <div className="absolute bottom-0 right-0 p-6">
            ...
            <div className="swiper-slide max-w-lg">
              <img className="transition-opacity duration-300 rounded-md" src={CarouselImage04} width="540" height="460" alt="Carousel item 04" />
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="flex grow">
                </div>
                <div className="absolute bottom-0 right-0 p-6">
            ...
            <div className="swiper-slide max-w-lg">
              <img className="transition-opacity duration-300 rounded-md" src={CarouselImage05} width="540" height="460" alt="Carousel item 05" />
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="flex grow">
                </div>
                <div className="absolute bottom-0 right-0 p-6">
